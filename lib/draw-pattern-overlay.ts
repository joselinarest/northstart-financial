...
export function drawPatternOverlay(g:CanvasRenderingContext2D,p:PatternEvidence,view:PatternBar[],plot:{left:number;right:number;top:number;bottom:number;cw:number;py:(value:number)=>number}){
