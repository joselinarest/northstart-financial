...
export function NorthstarWorkspace({ initialTab = "Dashboard", initialInvestmentId, focusInvestmentAnalysis = false }: { initialTab?: string; initialInvestmentId?: string; focusInvestmentAnalysis?: boolean }) {
  ...
  const pathByTab: Record<string,string> = { Dashboard:"dashboard", Accounts:"accounts", "Market Intel":"markets", Portfolio:"portfolio", "Professional Charts":"charts", "Market News":"market-news", "Growth Finder":"growth", "Bills & cards":"cash-flow", "Daily Action Plan":"daily-action-plan", Liabilities:"debt", Household:"household", "Ask Northstar":"assistant", "Prepare Trade":"planner", "Paper Simulator":"simulation", Journal:"journal", Learn:"academy", Settings:"settings", Help:"help" };
  ...
  const navigationGroups = [
    ...
    {name:"Swing / Options Accounts",items:[["Daily Action Plan","☀"],["Prepare Trade","◎"]]},
    ...
    <main className={`workspace-view page-${(pathByTab[tab] || "dashboard").replace(/[^a-z-]/g, "")} ${focusInvestmentAnalysis?"page-research-detail":""}`}>
      ...
      <div className="shell">
        ...
        <section className="content">
          ...
          {tab==="Daily Action Plan"&&<ActionGuidancePanel accountId={swingAdvisorAccount?String(swingAdvisorAccount.id):""} accessToken={accessToken} mode="today"/>}
