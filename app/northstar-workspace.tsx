      ...
      <div className="shell app-shell">
        ...
        <section className="content page-container" aria-busy={routeLoading}>
          ...
          {tab==="Accounts"&&<section className="connected-accounts card">
            <div className="accounts-head"><div><span>▣ READ-ONLY FINANCIAL CONNECTIONS</span><h2>Bank, cards, and loans</h2><p>Connect through Plaid to track balances, spending, and liabilities. Chase investment accounts are excluded from this flow because Plaid currently fails when they are selected; add investments through the manual portfolio instead. Northstar cannot transfer money or place trades.</p></div><button className="primary" disabled={plaidBusy} onClick={connectPlaid}>{plaidBusy?"Connecting…":"+ Connect bank or card"}</button></div>
