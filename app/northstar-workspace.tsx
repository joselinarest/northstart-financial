...
export function NorthstarWorkspace({ initialTab = "Dashboard", initialInvestmentId, focusInvestmentAnalysis = false, initialFinanceAccountId = "" }: { initialTab?: string; initialInvestmentId?: string; focusInvestmentAnalysis?: boolean; initialFinanceAccountId?: string }) {
  ...
  useEffect(()=>{if(["Dashboard","Accounts","Account Transactions","Portfolio","Market Intel","Prepare Trade","Professional Charts"].includes(initialTab)&&signedIn)loadConnectedFinance()},[initialTab,signedIn,accessToken]);
  useEffect(()=>{if(!signedIn)return;if(initialTab==="Household")loadHousehold();if(["Dashboard","Accounts","Account Transactions","Portfolio","Market Intel","Prepare Trade","Professional Charts"].includes(initialTab))loadConnectedFinance()},[realtimeTick]);
