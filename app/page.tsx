        ...
        <section className="content">
          ...
          <div className="hero" id="dashboard-top">
            <div>
              ...
              <h1>{tab==="Dashboard"?"Start here: understand today, then choose one action.":tab==="Daily Action Plan"?"Today’s live market action plan.":tab==="Dividend Growth"?"Find durable dividends with room to grow.":tab==="Household"?"Your household financial command center.":tab==="Learn"?"Learn investing from foundation to professional practice.":tab==="Paper Simulator"?"Practice decisions without risking real money.":"Your professional trading copilot."}</h1>
              <p>
