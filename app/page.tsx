        ...
        <section className="content">
          ...
          <section className="card planner" id="trade-planner">
            ...
            <div className="plan-grid">
              ...
              <div className="blueprint">
                ...
                <button disabled={!swingAdvisorAccount} onClick={() => navigate("Paper Simulator")}>
          ...
          <footer>
            {tab==="Daily Action Plan"
              ? "Live market decision support—not an order. Verify the current quote, trigger, liquidity, position size, and invalidation immediately before acting. Market conditions can change and no strategy guarantees profit."
              : "Educational decision support only—not financial advice. Market data in this prototype is illustrative. No strategy can guarantee profit."}
          </footer>
        </section>
      </div>
    </main>
