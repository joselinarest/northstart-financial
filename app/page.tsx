      ...
      <div className="shell">
        ...
        <section className="content">
          ...
          <section className="portfolio-builder card">
            {tab==="Portfolio"&&!!connectedFinance.holdings.length&&<section className="holdings-table analysis-holdings"><h3><small>ANALYSIS INPUT · CURRENT PORTFOLIO</small>Investment holdings, growth tracking, and evaluation</h3><ConnectedHoldingsAnalysis holdings={longTermHoldings} mode="long-term" accessToken={accessToken} horizon="2 years" onOpen={symbol=>{sessionStorage.setItem("northstar-chart-symbol",symbol);setChartSymbol(symbol);navigate("Professional Charts")}} /></section>}
