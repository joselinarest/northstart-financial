...
for(const text of ["Why is this not in the list?","Best for this account","Why it ranks here","Why it could fail","Eligible universe"])assert.match(ui,new RegExp(text.replace(/[?]/g,"\\?")));
