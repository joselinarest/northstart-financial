...
for(const token of ["accountId","portfolio_fit","account_rank","TOP_OPPORTUNITY","REJECTED_NOT_SUITABLE","existingWeight","sectorWeight"])assert.match(engine,new RegExp(token));
